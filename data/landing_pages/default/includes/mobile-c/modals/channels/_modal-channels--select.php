...
<div class="modal__header">
	...
	<h2 class="modal__header-channel-title">DIRECTV Select&trade;<br>All Included</h2>
	<p class="modal__header-channel-count"><?= $dtvProductsSelect->Channels->Total; ?>+ Channels</p>
