...
<div class="modal__header">
	...
	<h2 class="modal__header-channel-title">DIRECTV Ultimate<br>All Included</h2>
	<p class="modal__header-channel-count"><?= $dtvProductsUltimate->Channels->Total; ?>+ Channels</p>
...
<?
	...
	foreach($Packages as $Package) {
		...
		if ($Package->PackageName == 'Ultimate') {
