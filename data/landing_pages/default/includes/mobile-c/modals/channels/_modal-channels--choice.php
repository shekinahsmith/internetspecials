...
<div class="modal__header">
	...
	<h2 class="modal__header-channel-title">DIRECTV Choice&trade;<br>All Included</h2>
	<p class="modal__header-channel-count"><?= $dtvProductsChoice->Channels->Total; ?>+ Channels</p>
