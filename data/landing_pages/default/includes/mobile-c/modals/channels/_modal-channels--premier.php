...
<div class="modal__header">
	...
	<h2 class="modal__header-channel-title">DIRECTV Premier&trade;<br>All Included</h2>
	<p class="modal__header-channel-count"><?= $dtvProductsPremier->Channels->Total; ?>+ Channels</p>
...
<?
	...
	foreach($Packages as $Package) {
		...
		if ($Package->PackageName == 'Premier') {
