...
<div class="modal__header">
	...
	<h2 class="modal__header-channel-title">DIRECTV Xtra<br>All Included</h2>
	<p class="modal__header-channel-count"><?= $dtvProductsXtra->Channels->Total; ?>+ Channels</p>
