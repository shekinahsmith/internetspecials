<form class="address-check-form js-address-check-form" action="/zip_check_post2.php" method="post">
	...
	<input type="hidden" class="js-redirect-field" name="redirect" value="/">
	...
	<input type="text" name="street" class="street" id="street" value="<? echo (isset($_SESSION['submission']['street'])) ? $_SESSION['submission']['street']: ''; ?>" required placeholder="Street Address, eg: 121 Main Street">
	<!-- /.street -->
